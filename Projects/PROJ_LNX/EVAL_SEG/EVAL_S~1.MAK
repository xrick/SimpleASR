...
# d:/djgpp/bin/gpr2mak.exe eval.gpr
vpath_src=../../../Source/eval_rec ../../../Source/baseclas ../../../Source/resconf
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=../objects/baseclas.o ../objects/diagnost.o ../objects/eval_rec.o\
	../objects/evalopt.o ../objects/evaluate.o ../objects/resconf.o\
	../objects/textclas.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
...
SPECIAL_LDFLAGS=
PROG_ARGS=
SRC_DIRS=../../../Source/eval_rec ../../../Source/baseclas\
	../../../Source/resconf
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
...
MAIN_TARGET=eval.exe
PROJECT_ITEMS=baseclas.cpp diagnost.cpp eval_rec.cpp evalopt.cpp\
	evaluate.cpp resconf.cpp textclas.cpp
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
	$(RHIDE_COMPILE_C)
...
DEPS_0=\
		...
		c:/linxres/projects/projectDjGpp/objects/eval_rec.o\
		c:/linxres/projects/projectDjGpp/objects/evalopt.o\
		c:/linxres/projects/projectDjGpp/objects/evaluate.o\
...
../objects/diagnost.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=eval_rec.cpp
../objects/eval_rec.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=evalopt.cpp
../objects/evalopt.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=evaluate.cpp
../objects/evaluate.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cpp.o)
DEPS_6=resconf.cpp
../objects/resconf.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cpp.o)
DEPS_7=textclas.cpp
../objects/textclas.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cpp.o)

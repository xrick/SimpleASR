...
# d:/djgpp/bin/gpr2mak.exe featur.gpr
vpath_src=../../baseclas ../../features ../../vetclas ../../resconf ../../ioclass ../../../source/baseclas ../../../source/resconf ../../../source/features ../../../source/ioclass ../../../source/vetclas
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
OBJFILES=../objects/arraycla.o ../objects/baseclas.o ../objects/diagclas.o\
	...
	../objects/labelcl.o ../objects/resconf.o ../objects/soundfil.o\
	../objects/soundlab.o ../objects/test_feature.o\
	../objects/textclas.o ../objects/vetclas.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
SRC_DIRS=../../baseclas ../../features ../../vetclas ../../resconf\
	../../ioclass ../../../source/baseclas ../../../source/resconf\
...
MAIN_TARGET=featur.exe
PROJECT_ITEMS=arraycla.cpp baseclas.cpp diagclas.cpp diagnost.cpp\
	dspproc.cpp feature.cpp labelcl.cpp resconf.cpp soundfil.cpp\
	soundlab.cpp test_feature.cpp textclas.cpp vetclas.cpp
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
	$(RHIDE_COMPILE_C)
...
DEPS_0=\
		...
		c:/linxres/projects/projectDjGpp/objects/test_feature.o\
...
../objects/feature.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cpp.o)
DEPS_7=labelcl.cpp
../objects/labelcl.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cpp.o)
DEPS_8=resconf.cpp
../objects/resconf.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cpp.o)
DEPS_9=soundfil.cpp
../objects/soundfil.o:: $(DEPS_9)
	$(RHIDE_COMPILE.cpp.o)
DEPS_10=soundlab.cpp
../objects/soundlab.o:: $(DEPS_10)
	$(RHIDE_COMPILE.cpp.o)
DEPS_11=test_feature.cpp
../objects/test_feature.o:: $(DEPS_11)
	$(RHIDE_COMPILE.cpp.o)
DEPS_12=textclas.cpp
../objects/textclas.o:: $(DEPS_12)
	$(RHIDE_COMPILE.cpp.o)
DEPS_13=vetclas.cpp
../objects/vetclas.o:: $(DEPS_13)
	$(RHIDE_COMPILE.cpp.o)

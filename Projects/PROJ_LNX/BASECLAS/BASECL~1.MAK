...
# d:/djgpp/bin/gpr2mak.exe testbase.gpr
vpath_src=baseclas ../../baseclas ../../../source/baseclas
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=../objects/baseclas.o ../objects/diagnost.o ../objects/testbase.o\
	../objects/textclas.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
...
SPECIAL_LDFLAGS=
PROG_ARGS=
SRC_DIRS=baseclas ../../baseclas ../../../source/baseclas
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
ifeq ($(strip $(RHIDE_OS)),)
...
MAIN_TARGET=testbase.exe
PROJECT_ITEMS=baseclas.cpp diagnost.cpp testbase.cpp textclas.cpp
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
	$(RHIDE_COMPILE_C)
...
DEPS_0=\
		...
		c:/linxres/projects/projectDjGpp/objects/testbase.o\
...
../objects/diagnost.o:: $(DEPS_2)
	$(RHIDE_COMPILE_CC_FORCE)
DEPS_3=testbase.cpp
../objects/testbase.o:: $(DEPS_3)
	$(RHIDE_COMPILE_CC_FORCE)
DEPS_4=textclas.cpp
../objects/textclas.o:: $(DEPS_4)
	$(RHIDE_COMPILE_CC_FORCE)

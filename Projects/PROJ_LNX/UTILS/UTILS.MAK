...
# d:/djgpp/bin/gpr2mak.exe multifop.gpr
vpath_src=../resconf ../../resconf ../../baseclas ../../utils ../../../source/baseclas ../../../source/resconf ../../../source/utils
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=../objects/baseclas.o ../objects/diagnost.o ../objects/multifop.o\
	../objects/resconf.o ../objects/textclas.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=
SRC_DIRS=../resconf ../../resconf ../../baseclas ../../utils\
	../../../source/baseclas ../../../source/resconf\
	../../../source/utils
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
...
MAIN_TARGET=multifop.exe
PROJECT_ITEMS=baseclas.cpp diagnost.cpp multifop.cpp resconf.cpp\
	textclas.cpp
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
...
DEPS_0=\
		...
		c:/linxres/projects/projectDjGpp/objects/multifop.o\
...
../objects/diagnost.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=multifop.cpp
../objects/multifop.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=resconf.cpp
../objects/resconf.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=textclas.cpp
../objects/textclas.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cpp.o)

...
# d:/djgpp/bin/gpr2mak.exe ioclas.gpr
vpath_src=../../baseclas ../../features ../../vetclas ../../resconf ../../ioclass ../../../source/vetclas ../../../source/baseclas ../../../source/resconf ../../../source/ioclass
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=../objects/baseclas.o ../objects/diagnost.o ../objects/labelcl.o\
	../objects/resconf.o ../objects/soundfil.o ../objects/soundlab.o\
	../objects/testione.o ../objects/textclas.o ../objects/vetclas.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
...
SRC_DIRS=../../baseclas ../../features ../../vetclas ../../resconf\
	../../ioclass ../../../source/vetclas ../../../source/baseclas\
	../../../source/resconf ../../../source/ioclass
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
ifeq ($(strip $(RHIDE_OS)),)
...
MAIN_TARGET=ioclas.exe
PROJECT_ITEMS=baseclas.cpp diagnost.cpp labelcl.cpp resconf.cpp\
	soundfil.cpp soundlab.cpp testione.cpp textclas.cpp vetclas.cpp
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
	$(RHIDE_COMPILE_C)
...
DEPS_0=\
		...
		c:/linxres/projects/projectDjGpp/objects/testione.o\
...
ioclas.exe:: $(DEPS_0)
	$(RHIDE_COMPILE_LINK)
DEPS_1=baseclas.cpp
../objects/baseclas.o:: $(DEPS_1)
	$(RHIDE_COMPILE.cpp.o)
DEPS_2=diagnost.cpp
../objects/diagnost.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=labelcl.cpp
../objects/labelcl.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=resconf.cpp
../objects/resconf.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=soundfil.cpp
../objects/soundfil.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cpp.o)
DEPS_6=soundlab.cpp
../objects/soundlab.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cpp.o)
DEPS_7=testione.cpp
../objects/testione.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cpp.o)
DEPS_8=textclas.cpp
../objects/textclas.o:: $(DEPS_8)
	$(RHIDE_COMPILE.cpp.o)
DEPS_9=vetclas.cpp
../objects/vetclas.o:: $(DEPS_9)
	$(RHIDE_COMPILE.cpp.o)

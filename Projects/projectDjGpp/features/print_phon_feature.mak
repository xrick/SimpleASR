...
# d:/djgpp/bin/gpr2mak.exe Printphonfeat.gpr
vpath_src=../../../source/ioclass ../../../source/features ../../../source/vetclas ../../../source/baseclas ../../../source/resconf
vpath %.c $(vpath_src)
vpath %.cc $(vpath_src)
vpath %.cpp $(vpath_src)
vpath %.C $(vpath_src)
...
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))
OBJFILES=../objects/arraycla.o ../objects/baseclas.o ../objects/diagnost.o\
	../objects/dspproc.o ../objects/feature.o ../objects/labelcl.o\
	../objects/print_ph_feat.o ../objects/resconf.o\
...
SPECIAL_LDFLAGS=
PROG_ARGS=
SRC_DIRS=../../../source/ioclass ../../../source/features\
	../../../source/vetclas ../../../source/baseclas\
	../../../source/resconf
WUC=
EDITORS=
RHIDE_OS=$(RHIDE_OS_)
...
MAIN_TARGET=printphonfeat.exe
PROJECT_ITEMS=arraycla.cpp baseclas.cpp diagnost.cpp dspproc.cpp\
	feature.cpp labelcl.cpp print_ph_feat.cpp resconf.cpp soundfil.cpp\
	soundlab.cpp textclas.cpp vetclas.cpp
%.o: %.c
	$(RHIDE_COMPILE.c.o)
%.o: %.i
	$(RHIDE_COMPILE_C)
...
DEPS_0=\
		...
		c:/linxres/projects/projectDjGpp/objects/print_ph_feat.o\
...
../objects/baseclas.o:: $(DEPS_2)
	$(RHIDE_COMPILE.cpp.o)
DEPS_3=diagnost.cpp
../objects/diagnost.o:: $(DEPS_3)
	$(RHIDE_COMPILE.cpp.o)
DEPS_4=dspproc.cpp
../objects/dspproc.o:: $(DEPS_4)
	$(RHIDE_COMPILE.cpp.o)
DEPS_5=feature.cpp
../objects/feature.o:: $(DEPS_5)
	$(RHIDE_COMPILE.cpp.o)
DEPS_6=labelcl.cpp
../objects/labelcl.o:: $(DEPS_6)
	$(RHIDE_COMPILE.cpp.o)
DEPS_7=print_ph_feat.cpp
../objects/print_ph_feat.o:: $(DEPS_7)
	$(RHIDE_COMPILE.cpp.o)
DEPS_8=resconf.cpp
...
../objects/soundlab.o:: $(DEPS_10)
	$(RHIDE_COMPILE.cpp.o)
DEPS_11=textclas.cpp
../objects/textclas.o:: $(DEPS_11)
	$(RHIDE_COMPILE.cpp.o)
DEPS_12=vetclas.cpp
../objects/vetclas.o:: $(DEPS_12)
	$(RHIDE_COMPILE.cpp.o)

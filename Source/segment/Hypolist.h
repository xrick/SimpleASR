...
//  |-------------------------------------------------------------------|
//  |                                                                   |
//  |   FILE:   hypolist.h (derived by hypolist for recognition         |
...
class HypoTree
	...
	public:
		...
		Boolean Check_Candidate_Presence_And_Get_Num(VetInt& candidate_map,
				 				p_candidate & num_candidate,
		...
		Boolean Viterbi(GenericStaticHmm::HypoList & sequence, t_index max_num_activate,
		...
		Boolean Viterbi_Beam(GenericStaticHmm::HypoList & sequence, t_real beam_coeff,
